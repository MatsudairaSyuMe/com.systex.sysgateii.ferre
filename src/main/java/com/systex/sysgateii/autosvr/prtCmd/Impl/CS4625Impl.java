...
//20200330			Sleep(100);
			Sleep(33); //20220427 MatsudairaSyuMe change from 50 to 33
		} while (++retry < 10);
		if (getIsShouldShutDown().get())
			return "DIS".getBytes();
...
//20200330			Sleep(100);
			//20220427 MatsudairaSyuMe    Sleep(50);
		} while (++retry < 10);
		if (getIsShouldShutDown().get())
			return "DIS".getBytes();
		;
...
//					wlen = 0;
					...
					log.debug("6.2 ===<><>{} {} Prt_Text leave S4625_PSO wlen={} i={}", this.curState, this.curChkState, sendhBuf2, i);
				}
			}
//		}
		return true;
