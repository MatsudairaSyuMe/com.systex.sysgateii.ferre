package com.systex.sysgateii.comm.pool.test.util;
 ...
 * Moified by MatsudairaSyuMe 2019/11/4
 */

public class EpollConnDroppingServer implements Closeable {
	...
	public EpollConnDroppingServer(final int port, final int dropEveryRequest) throws InterruptedException {
		dispatchGroup = new EpollEventLoopGroup();
		workerGroup = new EpollEventLoopGroup();
		final ServerBootstrap bootstrap = new ServerBootstrap().group(dispatchGroup, workerGroup)
